...
print("FrEAC - Starting Modules")
wait(5)
print("FrEAC - Sucess Starting modules")

print("FrEAC - Sucess AC LOADED")
wait(5)
print(player.Name.." Conectou ao FrE - (MODULO #3) ")
